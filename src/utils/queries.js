module.exports = {
    ...
    getAnswer: 'SELECT form.title_form, question.title_q, question.value AS question, answer.value, answer.user_id, form.form_id FROM answer JOIN question ON answer.question_id = question.question_id JOIN form ON form.form_id = question.form_id and form.form_id = $1',
