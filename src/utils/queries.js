module.exports = {
    ...
    getAnswer: 'SELECT form.title_form, question.title_q, answer.value, answer.user_id FROM answer INNER JOIN question ON answer.question_id = question.question_id INNER JOIN form ON form.form_id = $1',
